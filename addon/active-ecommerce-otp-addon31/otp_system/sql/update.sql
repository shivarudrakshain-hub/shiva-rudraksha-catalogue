...
(7, 'account_opening', 'Hi! An account has been created on [[site_name]]. Your account type is: [[user_type]], password is: [[password]] and the verification code is [[code]] .', NULL, '1', current_timestamp(), current_timestamp()),
(8, 'login_with_otp', 'Your otp verification code is [[code]]', NULL, '1', current_timestamp(), current_timestamp());
...
VALUES 
(NULL, 'purchase_with_otp', 'Your otp verification code is [[code]]', NULL, '1', current_timestamp(), current_timestamp());
